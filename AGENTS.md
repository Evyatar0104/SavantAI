...
2. **Hebrew first** — all UI text in Hebrew. Proper nouns stay in English: Codex, ChatGPT, Gemini, NotebookLM, Google, OpenAI.
...
public/
  assets/logos/  → Codex.png, chatgpt.png, gemini.png
