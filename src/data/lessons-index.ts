...
export const LESSON_INDEX: LessonMeta[] = [
    ...
    { id: "chatgpt-canvas", trackId: "ai", courseId: "course-chatgpt", categoryId: "tools", order: 5, title: "Canvas — לכתוב ולקודד ביחד עם ChatGPT", icon: "🖊️", description: "ממשק עבודה צידי ומפוצל המאפשר עריכת מסמכים שלמים וקוד ללא איבוד רצף ההקשר ומבלי לעשות פעולות 'Copy-Paste' סזיפיות." },
    ...
    { id: "chatgpt-plans-pricing", trackId: "ai", courseId: "course-chatgpt", categoryId: "tools", order: 10, title: "Free, Go, Plus, Pro — מה שווה לשלם", icon: "💳", description: "פריסת מנויים כנה וללא יומרה: מי צריך דחיפת Plus מלאה, מתי מספיקה Go צנועה, ולמי עדכון החינם הופך להיות כסתור מעצבן." },
