...
export const LESSON_INDEX: LessonMeta[] = [
    ...
    { id: "chatgpt-platform-2026", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 1, title: "ChatGPT של 2026 — זה כבר לא רק צ'אט", icon: "🚀", description: "900 מיליון משתמשים עושים בו שימוש יומיומי, אבל רובם עדיין תקועים ב-2023. הגיע הזמן להתקדם." },
    { id: "chatgpt-memory-instructions", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 2, title: "Memory — הוא זוכר מי אתה (אם תלמד אותו)", icon: "🧠", description: "פיצ'רים כמו זיכרון והוראות מותאמות ימנעו ממך לחזור על אותם פרטים שוב ושוב בכל שיחה חדשה." },
    { id: "chatgpt-projects", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 3, title: "Projects — שיחות מאורגנות, context שנשמר", icon: "📁", description: "קובץ קבוע, מטרה ברורה, ושמירת הקשר לכל שיחה חדשה. הכלי שהופך סשן מחקר בוסרי ליחידת עבודה מוגמרת." },
    { id: "chatgpt-deep-research", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 4, title: "Deep Research — מחקר של שעות בדקות", icon: "🔬", description: "הסוכן שיודע לחקור, להצליב, לקרוא ולחזור אליך אחרי 15 דקות עם דוח מלא, שמשנה את צורת העבודה והלימוד. (דרישה: מנוי Plus)" },
    { id: "chatgpt-canvas", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 5, title: "Canvas — לכתוב ולקודד ביחד עם ChatGPT", icon: "🖊️", description: "ממשק עבודה צידי ומפוצל המאפשר עריכת מסמכים שלמים וקוד ללא איבוד רצף ההקשר ומבלי לעשות פעולות 'Copy-Paste' סיזיפיות." },
    { id: "chatgpt-custom-gpts", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 6, title: "Custom GPTs — אלפי כלים מוכנים, חינם", icon: "🧩", description: "חנות מלאה בכלים שמישהו אחר טרח כדי להגדיר. עוזר תכנות, עורך דין ויורשה לכתיבה - נמצאים במרחק הקלקה." },
    { id: "chatgpt-voice-mode", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 7, title: "Voice Mode — ChatGPT שמקשיב ועונה בקול", icon: "🎙️", description: "לדבר למודל בזמן אמת בלי לעבוד עם ההקלדה המתישה. מצב סופר נוח לנסיעות, סיעורי מוחות, ותרגול פרונטלי." },
    { id: "chatgpt-connectors", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 8, title: "Connectors — ChatGPT מחובר לכלים שלך", icon: "🔌", description: "בלי להעתיק מסמכים ארוכים הלוך ושוב: לחבר ישירות את המודל ל-Google Drive, Slack וסביבות החברה המשותפות שלך." },
    { id: "chatgpt-agent-mode", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 9, title: "Agent Mode — ChatGPT שעושה, לא רק מדבר", icon: "🤖", description: "מוד ה-Agent מאפשר למודל לשוטט באתרים עבורך, ללחוץ, להכניס נתונים באופן עצמאי לקבלת משימה ברורה מהחיים." },
    { id: "chatgpt-plans-pricing", trackId: "ai", courseId: "course-chatgpt", categoryId: "models", order: 10, title: "Free, Go, Plus, Pro — מה שווה לשלם", icon: "💳", description: "פריסת מנויים כנה וללא יומרה: מי צריך דחיפת Plus מלאה, מתי מספיקה Go צנועה, ולמי עדכון החינם הופך להיות כפתור מעצבן." },

    // ── course-claude (10 lessons) ──
    { id: "claude-honest-by-design", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 1, title: "Claude לא מנסה לרצות אותך — וזו בדיוק הנקודה", icon: "🎯", description: "Claude בנוי להיות ישר, לא נעים — וזה הופך אותו לשימושי יותר כשמשהו חשוב." },
    { id: "claude-long-context", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 2, title: "תן לו 500 עמוד — הוא לא יאבד את הדרך", icon: "📄", description: "חלון הקשר של 200K טוקנים הופך ניתוח מסמכים ארוכים למשהו שאפשר לעשות בפועל." },
    { id: "claude-writing-voice", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 3, title: "הכתיבה שנשמעת כמוך — לא כמו AI", icon: "✍️", description: "Claude מייצר את הכתיבה הכי אנושית מבין המודלים — ועם ההגדרה הנכונה, היא תישמע כמוך." },
    { id: "claude-projects", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 4, title: "Projects — תפסיק להסביר את עצמך מחדש בכל שיחה", icon: "📁", description: "Projects הם סביבת עבודה קבועה עם זיכרון, קבצים, והוראות — עכשיו בחינם לכולם." },
    { id: "claude-artifacts", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 5, title: "Artifacts — הפלט שאפשר לשלוח, לשתף ולהמשיך לבנות", icon: "🔧", description: "Artifact הוא תוצר עצמאי — מסמך, כלי, אפליקציה אינטראקטיבית — לא עוד תשובה בצ'אט." },
    { id: "claude-thinking-partner", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 6, title: "להחליט דברים קשים — Claude כחבר שחושב איתך", icon: "🧠", description: "שימוש ב-Claude לחשיבה ולקבלת החלטות — לא רק למשימות — הוא השימוש עם הערך הגבוה ביותר." },
    { id: "claude-extended-thinking", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 7, title: "Extended Thinking — תגיד לו לחשוב לפני שהוא עונה", icon: "⚙️", description: "Extended Thinking הוא מצב שבו Claude חושב בקול לפני שהוא עונה — ומשפר דיוק ב-30-35% על משימות מורכבות." },
    { id: "claude-google-workspace", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 8, title: "Google Workspace — Claude בתוך ה-Docs וה-Gmail שלך", icon: "📧", description: "מנויי Pro מקבלים אינטגרציה ישירה עם Google Docs, Gmail ו-Drive — Claude קורא ועורך קבצים אמיתיים שלך." },
    { id: "claude-cowork", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 9, title: "Cowork — תן לו משימה ותחזור כשסיים", icon: "🤖", description: "Cowork (Pro+) הוא Claude שעובד אוטונומית על קבצים ומשימות במחשב שלך — בלי פיקוח צמוד." },
    { id: "claude-plans-pricing", trackId: "ai", courseId: "course-claude", categoryId: "models", order: 10, title: "Free, Pro, Max — ההחלטה הכנה", icon: "💳", description: "פירוט ישיר של תוכניות Claude — בלי upsell, עם המלצה ברורה לפי שימוש." },

    // ── course-gemini (10 lessons) ──
    { id: "gemini-ecosystem-intro", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 1, title: "Gemini לא רק אפליקציה — הוא בכל מקום שאתה כבר נמצא", icon: "🌐", description: "רוב האנשים פותחים את האתר של גוגל ומתכתבים עם צ'אט. הם מפספסים 90% מהערך." },
    { id: "gemini-gmail", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 2, title: "Gemini ב-Gmail — תפסיק לבזבז שעתיים על האימייל", icon: "📧", description: "העובד הממוצע מבזבז שעות על ניהול דואר. Gemini תוקף את זה מארבעה כיוונים." },
    { id: "gemini-search", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 3, title: "Gemini ב-Google Search — חיפוש שמבין מה אתה באמת שואל", icon: "🔍", description: "גוגל הוא כבר לא רק רשימת קישורים. ה-AI נותן תשובות מלאות עם מקורות." },
    { id: "gemini-workspace-docs-sheets", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 4, title: "Gemini ב-Docs, Sheets, Slides — מסמכים שכותבים את עצמם", icon: "📝", description: "ה-AI מוטמע כפאנל צדדי בכל כלי העבודה. הוא מכיר את הקבצים שלכם ב-Drive." },
    { id: "gemini-deep-research", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 5, title: "Deep Research — מחקר של יום עבודה בפחות מ-20 דקות", icon: "🔬", description: "סוכן אוטונומי שגולש במאות אתרים עבורכם. דורש AI Pro." },
    { id: "gemini-agent", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 6, title: "Gemini Agent — תן לו משימה שדורשת כמה כלים", icon: "🤖", description: "השלב הבא של ה-AI: משימות מרובות שלבים אוטונומיות לגמרי. דורש AI Ultra." },
    { id: "gemini-drive", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 7, title: "Gemini ב-Drive — הקבצים שלך הופכים לידע שאפשר לשאול", icon: "💾", description: "ה-Drive שלכם הוא כבר לא רק מחסן קבצים. הוא בסיס ידע אינטראקטיבי." },
    { id: "gemini-gems", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 8, title: "Gems — תבנה AI מומחה לכל משימה חוזרת שלך", icon: "💎", description: "צרו גירסאות מותאמות אישית של Gemini עם הוראות קבועות וקבצים מצורפים." },
    { id: "gemini-ecosystem-connected", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 9, title: "הכל מחובר — ככה ה-Ecosystem של Gemini עובד ביחד", icon: "🔗", description: "העוצמה האמיתית היא האינטגרציה. איך כל הכלים שדיברנו עליהם מתקשרים אחד עם השני." },
    { id: "gemini-plans-pricing", trackId: "ai", courseId: "course-gemini", categoryId: "models", order: 10, title: "Free / AI Pro / AI Ultra — ההחלטה הכנה", icon: "💳", description: "השוואה אובייקטיבית של המסלולים. מה באמת מקבלים בעד הכסף?" },
    ...
    { id: "gems-gpts-01", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 1, title: "הצ'אט הרגיל שלך שוכח הכל. יש פתרון", icon: "🔄", description: "כל שיחה מתחילה מאפס — אלא אם כן אתה משתמש ב-Gem או GPT." },
    { id: "gems-gpts-02", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 2, title: "מישהו כבר בנה את מה שאתה צריך", icon: "🏪", description: "לפני שאתה בונה — תבדוק אם זה כבר קיים. הסטור מלא בפתרונות מוכנים." },
    { id: "gems-gpts-03", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 3, title: "אתה יכול להגיד לו מי להיות", icon: "🎭", description: "מאחורי כל Gem ו-GPT יש הוראות שמגדירות את האישיות שלו. ועכשיו אתה הולך לראות אותן." },
    { id: "gems-gpts-04", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 4, title: "בוט שבנית בעצמך ב-10 דקות", icon: "🔨", description: "אתה לא צריך לדעת לתכנת. רק לדעת מה אתה רוצה — ואיך לכתוב את זה בבהירות." },
    { id: "gems-gpts-05", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 5, title: "למה הבוט שלך מתנהג כמו ילד קטן — ואיך לתקן את זה", icon: "🔬", description: "בנית בוט, הוא לא עושה מה שרצית. זה לא כישלון — זה שלב חובה בתהליך." },
    { id: "gems-gpts-06", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 6, title: "תן לו זיכרון, מסמכים, וכלים", icon: "📎", description: "בוט בסיסי יודע מה כתבת לו. בוט מתקדם יודע גם מה העלית לו — וניגש לאינטרנט בזמן אמת." },
    { id: "gems-gpts-07", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 7, title: "Gems או GPTs — תבחר נכון", icon: "⚖️", description: "לא מדובר באיזה מודל חכם יותר. מדובר באיזה מערכת כלים מתאימה לחיים שלך." },
    { id: "gems-gpts-08", trackId: "ai", courseId: "course-gems-gpts-mastery", categoryId: "tools", order: 8, title: "הבוט שחוסך לך שעה בשבוע", icon: "⏱️", description: "לא כל משימה שווה בוט. הנה איך לזהות את זו שכן." },
    ...
    { id: "grok-mastery-1", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 1, title: "ה-AI שלא מפחד לקלל אותך", icon: "🌶️", description: "למה Grok אומר לך את האמת הלא-נוחה בלי להתנצל – וזה דווקא יתרון ענק" },
    { id: "grok-mastery-2", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 2, title: "לחקור את סודות היקום עם ה-AI?", icon: "🌌", description: "למה Grok לא סתם עוד צ'אטבוט – והמשימה הגדולה שמאחוריו" },
    { id: "grok-mastery-3", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 3, title: "לדעת מה קורה עכשיו - לפני כולם?", icon: "📡", description: "היתרון הכי גדול של Grok: מידע בזמן אמת ששום AI אחר לא יכול להשיג" },
    { id: "grok-mastery-4", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 4, title: "סרטון הוליוודי ב-10 שניות?", icon: "🎬", description: "Grok Imagine – טקסט לתמונה + טקסט לסרטון 10 שניות עם סאונד" },
    { id: "grok-mastery-5", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 5, title: "לדבר עם ה-AI בלי להקליד מילה?", icon: "🎙️", description: "Voice Mode של Grok – שיחה טבעית, מהירה, עם כלים בזמן אמת" },
    { id: "grok-mastery-6", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 6, title: "אפס טעויות? הסוד של Think Mode", icon: "🧠", description: "Think Mode, DeepSearch, low hallucination ו-strict prompt adherence" },
    { id: "grok-mastery-7", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 7, title: "לבנות עוזר אישי שחוסך שעות?", icon: "💼", description: "Workflows, פרומפטינג, checkpoints וטיפים מתקדמים" },
    { id: "grok-mastery-8", trackId: "ai", courseId: "grok-mastery", categoryId: "models", order: 8, title: "גרוק באמת מנצח את ChatGPT וקלוד?", icon: "⚔️", description: "השוואה ישירה + מתי Grok מנצח" },

    // ── course-perplexity (8 lessons) ──
    { id: "perplexity-mastery-1", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 1, title: "Perplexity תמיד מראה לך מאיפה הוא לקח את התשובה", icon: "🔍", description: "ההבדל הגדול בין Perplexity לכל שאר ה-AI" },
    { id: "perplexity-mastery-2", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 2, title: "למה Perplexity מחליף את Google Search", icon: "🌐", description: "המעבר מגוגל ל-Perplexity – ומה משתנה" },
    { id: "perplexity-mastery-3", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 3, title: "Deep Research – מחקר עמוק שעושה את כל העבודה בשבילך", icon: "🔬", description: "Pro Search ו-Deep Research – הכלי הכי חזק של Perplexity" },
    { id: "perplexity-mastery-4", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 4, title: "Model Council – מה קורה כשמריצים 3 מודלים בו זמנית?", icon: "🏛️", description: "הפיצ'ר שמשלב כמה AI כדי לתת תשובה מדויקת יותר" },
    { id: "perplexity-mastery-5", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 5, title: "Perplexity Computer – העוזר שמבצע פרויקטים שלמים לבד", icon: "💻", description: "ה-agent החזק ביותר של Perplexity" },
    { id: "perplexity-mastery-6", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 6, title: "Comet – הדפדפן שחושב ומבצע משימות בשבילך", icon: "☄️", description: "הדפדפן החכם של Perplexity" },
    { id: "perplexity-mastery-7", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 7, title: "איך להפוך את Perplexity לעוזר יומיומי חזק", icon: "🛠️", description: "טיפים ו-workflows מתקדמים" },
    { id: "perplexity-mastery-8", trackId: "ai", courseId: "course-perplexity", categoryId: "models", order: 8, title: "מתי כדאי להשתמש ב-Perplexity", icon: "⚖️", description: "השוואה והחלטה מתי הוא הכלי הנכון" },
];
