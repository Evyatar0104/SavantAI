...
export const COURSES: Course[] = [
    ...
    },
    {
        ...
        categoryId: "models",
        name: "Perplexity — The Complete Guide",
        nameHe: "Perplexity — המדריך המלא",
        description: "בקרוב — איך להחליף את גוגל במנוע חיפוש אינטליגנטי באמת",
        icon: "@perplexity.png",
        image: "/assets/logos/perplexity.png",
        order: 4,
        isLocked: true
        },
        {
        id: "grok-mastery",
        categoryId: "models",
        name: "Grok — The Complete Guide",
        nameHe: "Grok — המדריך המלא",
        description: "הגישה של xAI למידע בזמן אמת, הומור חריף והבנת היקום.",
        icon: "@grok.png",
    ...
    {
        id: "course-gems-gpts-mastery",
        categoryId: "tools",
        nameHe: "Gems ו-GPTs",
        name: "Gems & GPTs",
        description: "תבנה בוטים עם אישיות, זיכרון וכללים — ב-10 דקות.",
        icon: "🤖",
        order: 2,
        isLocked: false
    },
